...
function LoginForm({ loginState, setLoginState, setUserName }) {
  ...
  const handleLogin = () => {
    ...
    if (!email) {
      ...
      fetch("https://40ea-61-101-53-142.ngrok-free.app/members/login", {
  ...
  const jwtTestfunc = () => {
    fetch("https://40ea-61-101-53-142.ngrok-free.app/members/jwtTest", {
      method: "POST",
      headers,
    }).then((res) =>
  ...
  return (
    <div className="container">
      ...
      <button onClick={jwtTestfunc} className="jwt-button">
        JWT TEST
      </button>
